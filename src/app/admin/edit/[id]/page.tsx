...
export default function EditJobPage({ params }: Props) {
  ...
  const handleSubmit = async () => {  
    try {
      ...
      const finalLocation = jobData.location === "custom" ? jobData.customLocation : jobData.location;
      const mappedLocation = jobData.location === "custom" 
        ? "SEOUL"
      ...
      const requestData = {
        ...
        employmentType: EMPLOYMENT_TYPE_MAPPING[jobData.employmentType],
